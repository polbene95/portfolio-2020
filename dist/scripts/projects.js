const projectsList = [
    ...
    },
    {
        ...
        techs: ['React.js', 'ContextAPI', 'Javascript', 'Express.js', 'Mongoose', 'MongoDB']
    ...
    },
    {
        ...
        techs: ['HTML5', 'CSS3', 'Javascript', 'Vue.js', 'JAVA 8', 'Spring Boot', 'Gradle', 'H2']
    ...
    },
    {
        ...
        techs: ['React.js', 'Redux', 'Javascript', 'Express.js', 'Mongoose', 'MongoDB', 'Passport']
    ...
    },
    {
        ...
        techs: ['EJS', 'Javascript', 'Express.js', 'Mongoose',  'Multer', 'GridFS', 'MongoDB']
...
const ProjectCard = ({
    ...
    const generateAllTechItems = () => {
        let techsTemplate = ``;
        techs.forEach(tech => techsTemplate += ` <p class="flip-card__inner__back__techs__item">${tech}</p>`);
